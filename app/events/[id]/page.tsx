...
import { Calendar, Users, MapPin, Clock, ArrowLeft, UserPlus, Share2 } from 'lucide-react'
...
export default function EventDetailPage() {
  ...
  const event = {
    ...
    participants: 45,
    maxParticipants: 50,
    description: "Develop essential leadership skills for community engagement and project management. This comprehensive workshop will cover communication skills, team building, project planning, and community organizing techniques.",
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-500 mt-2 text-center">
                  Registration is free for all youth members
                </p>
              </CardContent>
            </Card>
          </div>
